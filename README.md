...
Public firewall/security-group policy:

- Allow inbound `UDP 443` for AmneziaWG.
- Allow inbound `TCP 22` for SSH administration.
- Do not expose the controller API publicly; it listens for local use on `av1`.
